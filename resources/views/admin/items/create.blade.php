...
<div class="container mx-auto px-4 py-8">
    ...
    <form action="{{ route('admin.items.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="total" id="total" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required min="0">
        </div>
